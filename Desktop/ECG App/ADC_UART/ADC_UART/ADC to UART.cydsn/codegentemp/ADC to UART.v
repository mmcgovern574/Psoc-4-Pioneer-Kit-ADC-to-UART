// ======================================================================
// ADC to UART.v generated from TopDesign.cysch
// 03/21/2018 at 21:47
...
module ADC_SAR_SEQ_P4_v2_40_0 (
	...
	cy_clock_v1_0
		#(.id("1adcfb39-747a-4936-a98c-9713f2c5dd02/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("925925925.925926"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
